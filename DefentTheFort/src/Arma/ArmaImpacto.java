...
public class ArmaImpacto extends Arma{
    ...
    public ArmaImpacto(int vida, int ataque, int campos, int rango, String nombre, ImageIcon imagen, Espacio espacio, Espacio[] matriz) {
        ...
        this.imagen = new ImageIcon("src\\Imagenes\\ArmaImpacto.png");
        this.matriz = matriz;
