...
public class ArmaContacto extends Arma{
    ...
    public ArmaContacto(int vida, int ataque, int campos, int rango, String nombre, ImageIcon imagen, Espacio espacio, Espacio[] matriz) {
        ...
        this.imagen = new ImageIcon("src\\Imagenes\\ArmaContacto.png");
        this.matriz = matriz;
